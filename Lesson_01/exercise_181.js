const s = 'Podstawą szczęścia jest wolność, a podstawą wolności odwaga.';

let text = `Operuję na zdaniu: "Podstawą szczęścia jest wolność, a 
podstawą wolności odwaga."
...
Po zamianie 'podstawą' na 'fundamentem' mamy:
"${s.replace('podstawą', 'fundamentem')}". 
